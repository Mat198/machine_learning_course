...
# Regression with train data

train_reg = LinearRegression()
train_reg.fit(feature_test, target_test)
print("Intercept", round(train_reg.intercept_,3))
print("Slope:", round(train_reg.coef_[0], 3))

train_data_score = train_reg.score(feature_train, target_train)
print("Training data regression score", train_data_score)

# Predicting against the long term incentive
...
plt.plot(feature_train, train_reg.predict(feature_train), color="g")
