...
cleaned_ages = [i[0] for i in cleaned_data]
cleaned_net_worths = [i[1] for i in cleaned_data]
print("After cleaning,",len(cleaned_ages), "points remained from", len(ages_train),"\n")

# Fitting again
reg.fit(cleaned_ages, cleaned_net_worths)
score = reg.score(ages_test, net_worths_test)
